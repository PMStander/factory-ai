...
In Factory CLI, launch a BMAD subagent via a slash wrapper, then run the task:

```bash
/use-architect Document the project
# then inside the session, run: *document-project
